...
def log_transacao(funcao):
    def envelope():
        try:
            ...
            txt_retorno_funcao = "falha" if result == False else "sucesso"

            with open(ROOT_PATH / "log.txt", "a", encoding="utf-8") as arquivo:
                texto_log = f"[{dia_atual}] A operação de {funcao.__name__.capitalize()} foi executada com {txt_retorno_funcao} e seu retorno foi {result}\n"
