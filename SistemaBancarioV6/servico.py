...
class ClienteServico:
    ...
    def filtrar_cliente(self, documento: str) -> Cliente | None:
        # verifica se é cpf e procura se existe no banco.
        if len(documento) == 11:
    ...
    def _criar_cliente(self, cliente: Cliente) -> int:
        ...
        # retorna o id da ultima linha inserida para referencia na tabela de pessoa
        return self.cursor.lastrowid
    
    def criar_cliente(self) -> None:
        documento = input("Informe o número do documento (CPF/CNPJ): ")
        ...
        # cria cliente e adiciona na tabela de pessoa
        if len(documento) == 11:
